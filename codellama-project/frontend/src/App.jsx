...
function App() {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        const res = await fetch('http://codellama-service.default.svc.cluster.local/history');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Refresh history
      const historyRes = await fetch('http://codellama-service.default.svc.cluster.local/history');
